...
| Phase-1 PDF | customer uploads or adjusts the approved Word template | P0 | ⚠️ | FB-116: 49-placeholder/12-chart Word template, Graph conversion, cleanup, validation and configurable Chromium fallback are implemented and deployed disabled; real Graph path awaits Microsoft 365 app/drive credentials |
