...
export function paperQuDetail(data) {
  return post('/exam/api/paper/paper/paperQu-detail', data)
}

export function getShowPdf(data) {
  return post('/exam/api/paper/paper/show_pdf', data)
}
